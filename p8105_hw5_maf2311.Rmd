...
No, the sample average of μ̂ across tests for which the null is rejected is not equal to the true value of μ for those with a lower power. This bias exists in the literature, and this exercise helps us to be skeptical of the data we see. 
